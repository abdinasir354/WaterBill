    ...
    <div className="min-h-screen flex flex-col bg-slate-900 font-sans">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-slate-800 p-10 rounded-2xl shadow-2xl border border-white/5">
          ...
          <p className="text-center text-slate-400 mb-8">Login to manage your water bills</p>

          {error && (
            <div className="bg-red-500/10 text-red-400 p-3 rounded-lg mb-6 flex items-center gap-2 text-sm font-medium border border-red-500/20">
          ...
          <div className="mt-8 text-center text-slate-400 text-sm">
            <p>Don't have an account? <Link to="/signup" className="text-cyan-400 font-medium hover:underline hover:text-cyan-300">Sign Up</Link></p>
